...
from .views import AdminCreateMachine, AdminGetUpdateDeleteMachine, GetMachine, UpdateMachine, DeleteMachine, GetDataLogs, GetMachines
...
urlpatterns = [
    ...
    path(r'machines', GetMachines.as_view(), name='get_machines'),
]
