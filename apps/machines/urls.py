...
from .views import AdminCreateMachine, AdminGetUpdateMachine, GetMachine, UpdateMachine, DeleteMachine, GetDataLogs

urlpatterns = [
    # path(r'admin/machine/', AdminCreateMachine.as_view(), name='admin_create_machine'),
    # path(r'admin/machine/<int:pk>/', AdminGetUpdateMachine.as_view(), name='admin_update_machine'),
